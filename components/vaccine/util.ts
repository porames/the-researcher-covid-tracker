...
import populationData from '../gis/data/province-population-data.json'
...
export function calculate_coverage(data) {
    data['data'].forEach((province, index) => {
        ...
        var population = provincePopulation["population"]
        ...
        data['data'][index]['over_60_1st_dose_coverage'] = province['over_60_1st_dose'] / provincePopulation[">60"]
        data['data'][index]['population_data'] = provincePopulation
